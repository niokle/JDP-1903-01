...
public class OrderControllerTest {
    ...
    public void testShouldCreateOrder() {
        ...
        product1.setOrderList(orderList);
        product2.setOrderList(orderList);
        product3.setOrderList(orderList);
        product4.setOrderList(orderList);

        //When
        Long order1Id = orderController.createOrder(orderController.orderMapper.mapToOrderDto(order1));
        Long order2Id = orderController.createOrder(orderController.orderMapper.mapToOrderDto(order2));
        ...
        orderDbService.deleteOrder(order1Id);
        orderDbService.deleteOrder(order2Id);
