...
public class GroupController {
    ...
    public Long createGroup(@RequestBody GroupDto groupDto) {
        return groupService.saveGroup(groupMapper.mapGroupDtoToGroup(groupDto)).getGroupId();
    }

    @PutMapping(value = "updateGroup", consumes = APPLICATION_JSON_VALUE)
    public GroupDto updateGroup(@RequestBody GroupDto groupDto) {
        return groupMapper.mapGroupToGroupDto(groupService.saveGroup(groupMapper.mapGroupDtoToGroup(groupDto)));
    }
